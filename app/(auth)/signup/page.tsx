    ...
    <div className="flex flex-col gap-8">
      <div className="text-center">
        ...
        >
          ...
          <span className="text-2xl font-bold tracking-tight text-zinc-100">Cortex</span>
        </div>
        <p className="text-sm text-zinc-500">Your memory. Every model.</p>
      </div>
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6 backdrop-blur-sm">
        ...
        <p className="text-sm text-zinc-500 mb-6">Start remembering</p>
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              required
              className="bg-white/[0.04] border-white/[0.08] text-zinc-100 placeholder:text-zinc-600 focus-visible:ring-indigo-500/50 focus-visible:border-indigo-500/50"
            />
          </div>
          <div className="space-y-1.5">
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-2 bg-transparent text-zinc-600">or</span>
          </div>
        </div>
